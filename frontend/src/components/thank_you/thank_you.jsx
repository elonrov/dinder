            ...
            <div>
                <section className="thank-you">
                    ...
                    <div className="created-by">Dinder was created by <br />
                        ...
                        <a className="link" rel="noopener noreferrer" target="_blank" href="http://www.elonrov.com">Harry Zec</a> <br /><br />Explore dinder's codebase and find more of our work on 
                        <a className="link" href="github.com"> GitHub.</a>
